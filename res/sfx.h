...
extern const unsigned char sfx_gothit[];

extern const unsigned char sfx_enemydestroy[];

extern const unsigned char sfx_powerup[];

extern const unsigned char sfx_die[];
